...
## [v1.30.0] - 2026-06-24
## Added
- Support for `site.matomo.userId` only for authenticated users. Consuming application should provide a stable unique identifier that has already been pseudonymized

## [v1.29.0] - 2026-06-15
## Added
- `footerIcons` **presets**: Added the following presets: 
```json
"footerIcons": [
  {
    "preset": "dsf-badge",
...
## Changed
- Updated to version 3.3.0 of the Unified Design System
...
- Removed unnecessary dependencies `semver`
- Moved `express` to dev dependency

## [v1.26.9] - 2026-03-27
### Changed
- Fixed vulnerabilities
- Harden dependency behaviour with picomatch safeguards
...
## [v1.26.0] - 2025-10-02
### Added
- Support to add custom CSS using the `site.customCSSFile`.
